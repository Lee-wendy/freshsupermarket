...
<head>
    ...
    <title>买菜助手--后台管理</title>

    <meta name="keywords" content="买菜能手">
    <meta name="description" content="买菜能手">
    ...
    <link href="<%=request.getContextPath()%>/css/style.min.css?v=4.0.0" rel="stylesheet">
</head>
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">${staffname}</strong></span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a class="J_menuItem" href="register.html">注册</a>
                                </li>
                                <li><a class="J_menuItem" href="login.html">切换账号</a>
                                </li>
                                <li class="divider"></li>
                    ...
                    <li>
                    	<a class="J_menuItem" href="<%=request.getContextPath()%>/index_v3.html"><i class="fa fa-columns"></i> <span class="nav-label">主页</span></a>
                    </li>
                    <li>
                     	<a class="J_menuItem" href="<%=request.getContextPath()%>/clients.html">员工信息</a>
                    </li>

                     <li>
                     	<a class="J_menuItem" href="<%=request.getContextPath()%>/clients.html">用户信息</a>
                     </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="hidden-xs">
                            <a href="<%=request.getContextPath()%>/index_v1.html" class="J_menuItem" data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a>
                        </li>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<%=request.getContextPath()%>/index_v2.html?v=4.0" frameborder="0" data-id="index_v2.html" seamless></iframe>
            </div>
            <div class="footer">
    ...
    <script src="<%=request.getContextPath()%>/js/hplus.min.js?v=4.0.0"></script>
