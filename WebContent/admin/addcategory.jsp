			...
			<form class="layui-form" action="<%=request.getContextPath()%>/admin/addcategory" method="post">
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_categoryname" name="categoryname" lay-verify="required|nikename" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="Lc_describe" name="categorydescribe" lay-verify="categorydescribe" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
